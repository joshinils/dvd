...
assert drive_number != None, "why u put no drive number, that dum"
...
#print("drive_open", drive_open(drive_number))
#print("drive_ready", drive_ready(drive_number))
#print("drive_full", drive_full(drive_number))


def wait_on_closed_drive():
    waiting = 1
